...
$gallerykeys = $article->mediaByMetaProperty( 'gallery', true );
...
<div class="grid_8">
	...
	<div id="story-sidebar" class="grid_4 omega">
		...
		<?php if( $mp4->length || $video->length || $audio->length || $slides->length ) : ?>
			<div class="mod-head">
				<h4>Multimedia</h4>
			</div>
			<div class="mod mb">
		...
		<?php if( $gallerykeys->length ) : ?>
			<div class="mod-head">
				<h4>Galleries</h4>
			</div>
			<div class="mod mb">
				<div class="inner">
				<?php foreach( $gallerykeys as $key ) :
					$gallery = _M( 'gallery' )->findByMedia( _M( 'media' )->find( 'media:uid = '. $key->uid ) )->shift(); ?>
					<div class="boot mmb">
						<div class="thumb mmb">
							<a href="<?php echo $gallery->url ?>"><img src="<?php echo $key->previewUrl ?>" alt="<?php echo $key->base_name ?>" /></a>
						</div>
						
						<div class="mmb">
							<div class="mmb"><img src="<?php echo Foundry::path('gfn-lanthorn/assets/icons/photo.png') ?>" />&nbsp;&nbsp;<a href="<?php echo $gallery->url ?>"><?php echo $gallery->name ?></a></div>
							<div class="aside2"><?php echo $gallery->description ?></div>
						</div>
						<div class="clear"> </div>
					</div>
				<?php endforeach; ?>

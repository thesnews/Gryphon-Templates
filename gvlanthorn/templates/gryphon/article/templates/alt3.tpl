...
$topImage = $article->mediaByMetaProperty( 'top', true );
...
<div id="alt3" class="grid_8">
	...
	<?php if ( $topImage ) : foreach ( $topImage as $item ) : ?>
		<?php if( $item->status == 0 ) echo '<div class="unp">'; ?>
		<div class="grid_6 alpha">
			<div class="mmb"><img src="<?php echo $item->bigUrl ?>" alt="<?php echo $item->base_name ?>" /></div>
	...
	<div class="body-copy">
		<?php echo Foundry::extract( $article->copy_formatted, 2 ) ?>
	</div>
	
	<div id="story-sidebar" class="grid_3 alpha">
	...
	<div class="body-copy boot mmb">
		<?php echo Foundry::extract( $article->copy_formatted, null, 2 ) ?>
		<div class="clear">&nbsp;</div>
	</div>

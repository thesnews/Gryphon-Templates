...
<div class="mmbox">
	...
	<div class="flat"><img src="<?php echo Foundry::path('gfn-lanthorn/assets/icons/soundslide.png') ?>" />&nbsp;<a href="<?php echo Foundry::link( 'multimedia/'.$this->uid ) ?>"><?php echo $this->title ?></a></div>

<div class="boot mmb">
	...
	<div class="mmb">
		<div class="mmb"><img src="<?php echo Foundry::path('gfn-lanthorn/assets/icons/audio.png') ?>" />&nbsp;<a href="<?php echo Foundry::link( 'multimedia/'.$this->uid ) ?>"><?php echo $this->title ?></a></div>

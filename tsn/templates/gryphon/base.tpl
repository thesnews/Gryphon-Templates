			...
			<div class="container_12" id="footer">
				<div class="grid_2">
						...
						<div id="copyright" class="small">
							All Content &copy; Copyright 2011, The State News, State News, Inc.<!-- | Valid <a href="http://validator.w3.org/check/referer">HTML</a> & <a href="http://jigsaw.w3.org/css-validator/validator?uri=#">CSS</a>--><br />
